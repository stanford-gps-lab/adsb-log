...
%
%   aircraftData = adsblog.importJSONLog(filename) imports the contents of
%   the JSON log specified by the filename (should be a full path).
...
aircraftData = adsblog.parser.jsonStructToAircraft(val);